...
class Restaurant(SoftDeleteModel):
    ...
    hide_sell_report = models.CharField(
        choices=RESTAURANT_REPORT_HIDE, max_length=50, default="FOOD_ORDER")
    number_of_report_hide = models.IntegerField(default=0)
    highest_price_amount_hide= models.FloatField(null=True, blank=True)
    lowest_price_amount_hide = models.FloatField(null=True, blank=True)
    hide_sell_report_is_percentage = models.BooleanField(default=False)
